...
<main class="page--content">
  ...
  <div class="card--content fade-contents">
    ...
    <section class="content-section content-section--right">
      ...
      <p>The United Kingdom is set to welcome the first hotel to open under The Unbound Collection By Hyatt brand. <strong>Great Scotland Yard</strong> is ready for a “smashing” debut in London. The former headquarters of the Metropolitan Police is now a one-of-a-kind luxury hotel, where a storied past is etched onto nearly every inch of the new, bespoke design. There are 153 stylish bedrooms and 11 suites, including a connected five-story townhouse, offering a uniquely intimate stay for the most discerning travelers. Secret doors conceal more hidden rooms, while celebrity chef Robin Gill brings a taste of the English countryside to the beating heart of Britain’s capital. <strong>Great Scotland Yard is now open.</strong></p>
    </section>
    ...
    <section class="content-section content-section--right bg-image--content--below-left">
      ...
      <p>Combining heritage guesthouse architecture with interiors by renowned hospitality designer Tony Chi, the newly-opened <strong>Park Hyatt Kyoto</strong> is poised to welcome guests with unrivaled omotenashi. This traditional Japanese hospitality philosophy presents luxury in every detail. Nestled beside the Kōdaiji Temple within the historic Higashiyama district, Park Hyatt Kyoto is an intimate hillside retreat designed in harmony with its peaceful surroundings. This serene setting is ideal for enjoying the region’s splendid seasons—including magnificent cherry blossoms—or for travelers planning a deeper exploration of Japan ahead of the 2020 Tokyo Olympics. <strong>Park Hyatt Kyoto is now open.</strong></p>
    </section>
  </div>
</main>
